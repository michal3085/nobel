...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Sekcje Q&A [{{$sections->count()}}]</h5>
...
{{--                        </th>--}}
                    ...
                    @foreach($sections as $key => $section)
                        <tr class="align-middle">
                            ...
                            <td>
                                {{ $section->getThreadsCount() }}
                            </td>
{{--                            <td class="text-center">--}}
{{--                                <form action="{{ route('qa.sections.status', $section) }}" method="POST" style="display:inline;">--}}
{{--                                    @csrf--}}
{{--                                    @method('PUT')--}}
{{--                                    @if ($section->qa_section_active === 1)--}}
