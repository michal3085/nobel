<section class=" section-frame overflow-hidden video-wrapper px-0 mt-0 min-vh-80">
    <video poster="/assets/media/nobel_movie.mov" src="/assets/media/nobel_movie.mov" autoplay loop playsinline muted></video>
    <div class="video-content">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-8 col-xl-6 text-center text-white mx-auto">
                    <h1 class="display-1 fs-54 text-white mb-5"><span class="rotator-zoom">Ty masz pomysł,My narzędzia do jego realizacji</span></h1>
